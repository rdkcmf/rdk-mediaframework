...
#ifndef __CARDMIBACCESSPROXYSERVER_H__
#define __CARDMIBACCESSPROXYSERVER_H__
...
void vlInitCardMibAccessProxy(char * pszOid, int nOidLen);
...
#endif // __CARDMIBACCESSPROXYSERVER_H__
