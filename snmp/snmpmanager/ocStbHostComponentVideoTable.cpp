...
initialize_table_ocStbHostComponentVideoTable(void)
{
    ...
    size_t          ocStbHostComponentVideoTable_oid_len =
        OID_LENGTH(ocStbHostComponentVideoTable_oid);
    ...
    table_data =
        netsnmp_tdata_create_table("ocStbHostComponentVideoTable", 0);
    ...
    table_info->min_column =
        COLUMN_OCSTBHOSTCOMPONENTVIDEOCONSTRAINEDSTATUS;
    table_info->max_column = COLUMN_OCSTBHOSTCOMPONENTVIDEOMUTESTATUS;

    netsnmp_tdata_register(reg, table_data, table_info);
    cache = netsnmp_cache_create(OCSTBHOSTCOMPONENTVIDEOTABLE_TIMEOUT/*-1*/,
                                 ocStbHostComponentVideoTable_load,
                                 ocStbHostComponentVideoTable_free,
                                 ocStbHostComponentVideoTable_oid,
                                 ocStbHostComponentVideoTable_oid_len);
  ...
  /*
         ...
         */
     if(0 == ocStbHostComponentVideoTable_load(cache,table_data))
    {
 ...
 */
int
ocStbHostComponentVideoTable_load(netsnmp_cache * cache,
                                      void *vmagic) {
    netsnmp_tdata* table_data = (netsnmp_tdata *) vmagic;
    netsnmp_tdata_row *row;

       SNMP_DEBUGPRINT("\n :::: Start ocStbHostComponentVideoTable_load :::::: \n");
       if(0 == vl_ocStbHostComponentVideoTable_getdata(table_data))
    {
      //vl_ocStbHostAVInterfaceTable_getdata"
      SNMP_DEBUGPRINT(" ERROR:: Not yet table initialise here \n");
       ...
       SNMP_DEBUGPRINT("........END .vl_ocStbHostComponentVideoTable_getdata ............\n");
...
void
 ocStbHostComponentVideoTable_free(netsnmp_cache * cache,
                                      void *vmagic) {
...
/** handles requests for the ocStbHostComponentVideoTable table */
int
ocStbHostComponentVideoTable_handler(netsnmp_mib_handler *handler,
    ...
    struct ocStbHostComponentVideoTable_entry *table_entry;
    int             ret;
    ...
    switch (reqinfo->mode) {
         ...
         */
    // SNMP_DEBUGPRINT("....ocStbHostComponentVideoTable_handler :: ..MODE_GET: ............\n");
    case MODE_GET:
        for (request = requests; request; request = request->next) {
           // table_entry = (struct ocStbHostComponentVideoTable_entry *)                netsnmp_tdata_extract_entry(request);
            /*changed due to wrong values in retriving first element of the Table*/
            VL_SNMP_PREPARE_AND_CHECK_TABLE_GET_REQUEST(ocStbHostComponentVideoTable_entry);
